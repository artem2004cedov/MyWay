...
public class AddNewTaskEat extends BottomSheetDialogFragment {
    ...
    public static AddNewTaskEat newInstance(){
        return new AddNewTaskEat();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(bundle != null){
            isUpdate = true;
            String task = bundle.getString("eat");
        ...
        newTaskSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(finalIsUpdate){
                    db.updateTaskEat(bundle.getInt("id_eat"), text);
                }
                else {
