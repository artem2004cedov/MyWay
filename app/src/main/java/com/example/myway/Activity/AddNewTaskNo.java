...
public class AddNewTaskNo extends BottomSheetDialogFragment {
    ...
    public static AddNewTaskNo newInstance(){
        return new AddNewTaskNo();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(bundle != null){
            isUpdate = true;
            String task = bundle.getString("no");
        ...
        newTaskSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(finalIsUpdate){
                    db.updateTaskNo(bundle.getInt("id_no"), text);
                }
                else {
