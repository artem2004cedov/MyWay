...
public class ToDoAdapterNo extends RecyclerView.Adapter<ToDoAdapterNo.ViewHolder> {

    private List<ToDoModel> todoList;
    private DatabaseHandler db;
    private ComparisonsActivity context;

    public ToDoAdapterNo(List<ToDoModel> todoList, DatabaseHandler db, ComparisonsActivity context) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.textTaskEat.setText(item.getNo());
        holder.textTaskDate.setText(item.getDate());
        holder.todoCheckBoxEat.setChecked(toBoolean(item.getStatus_no()));
...
//                    holder.task.setPaintFlags(holder.task.getPaintFlags() | Paint.ANTI_ALIAS_FLAG);
    ...
    public void setTasksNo(List<ToDoModel> todoList) {
        this.todoList = todoList;
