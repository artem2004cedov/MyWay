package com.example.myway.SwipesActivity;
...
public class RecyclerItemTouchHelperEat extends ItemTouchHelper.SimpleCallback {

    private ToDoAdapterEat adapter;

    public RecyclerItemTouchHelperEat(ToDoAdapterEat adapter) {
        ...
        if (direction == ItemTouchHelper.LEFT) {
            ...
            textDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    adapter.deleteItemEat(position);
                    dialog.dismiss();
                }
            });

            TextView textBack = dialog.findViewById(R.id.textBack);
