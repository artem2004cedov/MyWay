...
public class RecyclerItemTouchHelperNo extends ItemTouchHelper.SimpleCallback {

    private ToDoAdapterNo adapter;

    public RecyclerItemTouchHelperNo(ToDoAdapterNo adapter) {
